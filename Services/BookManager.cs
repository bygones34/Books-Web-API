...
namespace Services
{
    public class BookManager : IBookService
    {
        ...
        {
            var entity = await GetOneBookByIdAndCheckExistanceAsync(id, trackChanges);
        ...
        private async Task<Book> GetOneBookByIdAndCheckExistanceAsync(int id, bool trackChanges)
        {
            var entity = await _manager.Book.GetOneBookByIdAsync(id, trackChanges);
